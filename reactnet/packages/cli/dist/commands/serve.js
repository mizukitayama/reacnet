...
const local_api_1 = require("@reactnet/local-api");
...
exports.serveCommand = new commander_1.Command()
    ...
    .action((filename = "reactnetbook.js", options) => __awaiter(void 0, void 0, void 0, function* () {
    const isLocalApiError = (err) => {
        return typeof err.code === "string";
    };
    try {
        const dir = path_1.default.join(process.cwd(), path_1.default.dirname(filename)); //whole absolute path to the file
